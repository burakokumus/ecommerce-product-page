...
export default function Home() {
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-col items-center justify-between py-6 overflow-hidden md:flex-row md:max-w-screen-lg md:mx-auto">
        ...
        <div className="mt-24 px-8">
          ...
          <div className="flex flex-col md:grid md:grid-cols-2 md:items-end gap-2">
            <Counter />
            <Button className="w-full mt-4 h-12 bg-orange-primary rounded-lg color-white font-semibold text-lg gap-4">
              <Image
